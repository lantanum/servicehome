...
from serviceapp.views import ActivateUserView, AmoCRMContactUpdateView, AmoCRMWebhookView, BalanceDepositConfirmView, BalanceDepositView, ClientCityUpdateView, ClientGroupMembershipUpdateView, ClientPhoneUpdateView, ClientRequestInfoView, ClientRequestsView, ClientReviewUpdateView, DeactivateUserView, MasterBalanceView, MasterCityUpdateView, MasterEquipmentUpdateView, MasterFreeRequestsView, MasterGroupCheckCallbackView, MasterGroupMembershipUpdateView, MasterMigrationAPIView, MasterNameUpdateView, MasterPhoneUpdateView, MasterProfileView, MasterServiceUpdateView, MasterStatisticsView, MasterStatsView, ServiceEquipmentTypesView, UpdateServiceRequestRatingView, UserRegistrationView, ServiceRequestCreateView, ServiceRequestHistoryView, MasterActiveRequestsView, AssignRequestView, CloseRequestView, UserProfileView, FinishRequestView
...
urlpatterns = [
    ...
    path('master_group_membership_update/', MasterGroupMembershipUpdateView.as_view(), name='master-group-membership-update'),
    path('client_group_membership_update/', ClientGroupMembershipUpdateView.as_view(), name='client-group-membership-update'),
    path("api/migrate/masters/", MasterMigrationAPIView.as_view(), name="migrate-masters"),
]
