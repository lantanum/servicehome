...
from serviceapp.views import AmoCRMWebhookView, ClientRequestsView, MasterFreeRequestsView, MasterStatisticsView, ServiceEquipmentTypesView, UserRegistrationView, ServiceRequestCreateView, ServiceRequestHistoryView, MasterActiveRequestsView, AssignRequestView, CloseRequestView, UserProfileView, FinishRequestView
